...
| Submit button                               | If no answer is selected the user will not be able to move to the next question and will receive an alert asking to select an answer | Click button, no answer selected | Alert was prompted for user to select an answer and quiz did not move on to the next question | Pass      |
| Submit button                               | Submits user answer and moves to next question                                                                                       | Click button                     | User is taken to next question                                                                | Pass      |
| Reload button                               | Reloads the quiz with a different random set of questions                                                                            | Click button                     | Quiz is restarted and a different set of random questions is loaded                           | Pass      |
...
- Go to the repository for this project, [WizQuiz](https://github.com/jflets/Wiz-Quiz)
